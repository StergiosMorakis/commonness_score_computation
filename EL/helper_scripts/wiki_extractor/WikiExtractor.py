...
def process_dump(
    ...
    with open("./wiki_redirects.txt", "w", encoding="utf-8") as rf:
        with open("./wiki_disambiguation_pages.txt", "w", encoding="utf-8") as dis_f:
            with open("./wiki_name_id_map.txt", "w", encoding="utf-8") as id_f:
